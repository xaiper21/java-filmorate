...
public class GenreRepository extends BaseRepository<GenreWithIdAndName> {
    private final static String FIND_BY_ID_QUERY = "SELECT id AS genre_id, name AS genre_name FROM genre WHERE id = ?";
    private final static String FIND_ALL_QUERY = "SELECT id AS genre_id, name AS genre_name FROM genre ORDER BY id ASC";
    private final static String INSERT_GENRE_FILM_QUERY = "INSERT INTO film_genre SET genre_id = ?, film_id = ?";
    private final static String DELETE_GENRE_FILM_QUERY = "DELETE FROM film_genre WHERE film_id = ?";
    private final static String FIND_ALL_GENRES_FILM_BY_ID_QUERY = "SELECT " +

...
public class FilmMapper {
    public static FilmResponseDto buildResponse(Film film, List<GenreWithIdAndName> genres, List<DirectorDto> directors) {
    ...
    public static Film mapToFilm(FilmCreateRequestDto filmCreateRequestDto, MpaWithIdAndName mpa, List<GenreWithId> genres) {
        Film film = new Film();
    ...
    public static Film updateFields(Film film, FilmUpdateDto request, MpaWithIdAndName mpa, List<GenreWithIdAndName> genres) {

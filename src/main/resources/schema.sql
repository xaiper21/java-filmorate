...
(
    ...
    CONSTRAINT fk_film_genre_film FOREIGN KEY
(
    film_id
) REFERENCES film
(
    ...
    CONSTRAINT fk_film_genre_genre FOREIGN KEY
(
    genre_id
) REFERENCES genre
(
...
(
    ...
    CONSTRAINT fk_film_like_user FOREIGN KEY
(
    user_id
) REFERENCES users
(
    ...
    CONSTRAINT fk_film_like_film FOREIGN KEY
(
    film_id
) REFERENCES film
(
...
(
    ...
    CONSTRAINT unique_id_users UNIQUE
(
    user_one_id,
    user_two_id
),
    CONSTRAINT check_user_order CHECK
(
    user_one_id
    <>
    user_two_id
),
    CONSTRAINT fk_friendship_user_one FOREIGN KEY
(
    user_one_id
) REFERENCES users
(
    ...
    CONSTRAINT fk_friendships_user_two FOREIGN KEY
(
    user_two_id
) REFERENCES users
(
...
(
    ...
    CONSTRAINT fk_film_director_film FOREIGN KEY
(
    film_id
) REFERENCES film
(
    ...
    CONSTRAINT fk_film_director_director FOREIGN KEY
(
    director_id
...
(
    ...
    CONSTRAINT fk_review_film FOREIGN KEY
(
    film_id
) REFERENCES film
(
...
(
    ...
    BOOLEAN
    NOT
    NULL, -- true для лайка, false для дизлайка
    PRIMARY
    KEY
(
    review_id,
    ...
    CONSTRAINT fk_review_like_review FOREIGN KEY
(
    review_id
) REFERENCES reviews
(
    ...
    CONSTRAINT fk_review_like_user FOREIGN KEY
(
    user_id
) REFERENCES users
(
